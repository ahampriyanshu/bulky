    ...
    function ProcessExcel(data) {
      try {
        ...
        for (var i = 0; i < excelRows.length; i++) {
          printPDFs = generatePDF(excelRows[i].Participant, excelRows[i].Title, excelRows[i].Organisation, excelRows[i].Event, excelRows[i].Sign, excelRows[i].Name, excelRows[i].Designation, excelRows[i].Layout);
        }
